#!/usr/bin/env python3
# Copyright (c) 2018-2022 The Renaiss Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
#
# Be aware that renaissd and renaiss-qt differ in terms of localization: Qt
# opts in to POSIX localization by running setlocale(LC_ALL, "") on startup,
# whereas no such call is made in renaissd.
#
...
# C locale.
#
# In contrast, renaissd does not opt in to localization -- no call to
# setlocale(LC_ALL, "") is made and the environment variables LC_* are
# thus ignored.
#
# This results in situations where renaissd is guaranteed to be running
# with the classic locale ("C") whereas the locale of renaiss-qt will vary
# depending on the user's environment variables.
#
# An example: Assuming the environment variable LC_ALL=de_DE then the
# call std::to_string(1.23) will return "1.230000" in renaissd but
# "1,230000" in renaiss-qt.
#
