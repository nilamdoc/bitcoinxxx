...
By default, renaissd will dump mempool on shutdown and
...
class MempoolPersistTest(RenaissTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent renaissd from writing mempool.dat to disk. Verify that `savemempool` fails")
