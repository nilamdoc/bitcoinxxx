...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/renaiss/renaiss/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(RenaissTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our renaissd node")
