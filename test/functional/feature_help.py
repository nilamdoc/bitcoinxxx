...
"""Verify that starting renaiss with -h works as expected."""

from test_framework.test_framework import RenaissTestFramework
from test_framework.util import assert_equal

class HelpTest(RenaissTestFramework):
    ...
    def run_test(self):
        self.log.info("Start renaiss with -h for help text")
        ...
        self.log.info("Start renaiss with -version for version information")
        ...
        self.log.info("Start renaissd with -fakearg to make sure it does not start")
