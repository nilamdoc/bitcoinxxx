...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RenaissTestFramework
    pass


class ExampleTest(RenaissTestFramework):
    # Each functional test is a subclass of the RenaissTestFramework class.
    ...
    def custom_method(self):
        ...
        RenaissTestFramework class so other tests can use it."""
