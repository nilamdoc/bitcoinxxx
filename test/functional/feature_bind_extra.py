...
"""
Test starting renaissd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(RenaissTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that renaissd has bound on "::1" (for RPC) and "::" (for P2P).
