...
class TestShell:
    """Wrapper Class for RenaissTestFramework.

    The TestShell class extends the RenaissTestFramework
    ...
    class __TestShell(RenaissTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by RenaissTestFramework child class.
            self.num_nodes = 1
