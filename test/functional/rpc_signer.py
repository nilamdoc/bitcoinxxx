...
Verify that a renaissd node can use an external signer command.
...
class RPCSignerTest(RenaissTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart renaissd with -signer=<cmd>',
