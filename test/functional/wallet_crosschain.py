...
class WalletCrossChain(RenaissTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].renaissconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].renaissconf, 'w', encoding='utf8') as conf:
