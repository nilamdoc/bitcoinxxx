...
class TxnMallTest(RenaissTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 REN:
        ...
        # First: use raw transaction API to send 1240 REN to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 REN coin each
        ...
        # Node0's balance should be starting balance, plus 50REN for another
        ...
        # Node0's total balance should be starting balance, plus 100REN for
