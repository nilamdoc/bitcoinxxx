...
class P2PPermissionsTests(RenaissTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].renaissconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].renaissconf, 'w', encoding="utf8") as f:
            f.write(newText)
