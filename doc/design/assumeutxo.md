...
Assumeutxo is a feature that allows fast bootstrapping of a validating renaissd
...
- [Github issue](https://github.com/renaiss/renaiss/issues/15605)
- [draft PR](https://github.com/renaiss/renaiss/pull/15606)
...
considered active. This is the "traditional" mode of operation for renaissd.
...
**Failure consideration:** if renaissd unexpectedly halts after `m_stop_use` is set on
...
### Renaissd restarts sometime after snapshot validation has completed

When renaissd initializes again, what began as the snapshot chainstate is now
