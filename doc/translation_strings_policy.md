...
This document provides guidelines for internationalization of the Renaiss Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `renaiss_en.ts` remains unchanged.
