Renaiss Core version 0.9.4 is now available from:

  https://renaiss.org/bin/0.9.4/
...
this update is incompatible with the Renaiss system and could lead to consensus
forks.

Renaiss Core released binaries from https://renaiss.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~renaiss/+archive/ubuntu/renaiss
- A third-party or self-compiled Renaiss Core

upgrade to Renaiss Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
