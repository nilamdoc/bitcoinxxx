Renaiss-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/renaiss/files/Renaiss/renaiss-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Renaiss
...
New/changed settings (command-line or renaiss.conf file)
--------------------------------------------------------
