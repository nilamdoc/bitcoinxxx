Renaiss Core version 0.14.2 is now available from:

  <https://renaiss.org/bin/renaiss-core-0.14.2/>
...
(in Renaiss Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate renaiss-config.h as necessary (theuni)
