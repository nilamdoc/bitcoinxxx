...
Renaiss Core version 0.19.1 is now available from:

  <https://renaisscore.org/bin/renaiss-core-0.19.1/>
...
From Renaiss Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Renaiss Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Renaiss Core does not yet change appearance when
...
- #17488 fix "renaissd already running" warnings on macOS (fanquake)
