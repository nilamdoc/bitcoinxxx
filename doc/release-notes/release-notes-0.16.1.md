Renaiss Core version 0.16.1 is now available from:

  <https://renaisscore.org/bin/renaiss-core-0.16.1/>
...
- #12843 `df38b13` Test starting renaissd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure renaissd processes are cleaned up when tests end (sdaftuar)
