Renaiss version 0.5.4 is now available for download at:
http://sourceforge.net/projects/renaiss/files/Renaiss/renaiss-0.5.4/
...
http://gitorious.org/renaiss/renaissd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Renaiss-Qt notifications under Growl 1.3.
Increase required age of Renaiss-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRenaiss properly when installing Renaiss-Qt over it. (Windows)
