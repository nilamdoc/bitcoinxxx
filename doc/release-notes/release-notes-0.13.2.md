Renaiss Core version 0.13.2 is now available from:

  <https://renaiss.org/bin/renaiss-core-0.13.2/>
...
- #8908 `4a974b2` Update renaiss-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow renaiss-tx to create v2 transactions (btcdrak)
