Renaiss Core version 0.10.4 is now available from:

  <https://renaiss.org/bin/renaiss-core-0.10.4/>
...
- #6953 `43c2789` Split renaiss-tx into its own package
- #6953 `dfe0d4d` Include renaiss-tx binary on Debian/Ubuntu
