Renaiss Core version *0.15.2* is now available from:

  <https://renaisscore.org/bin/renaiss-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in renaiss-tx (TheBlueMatt)
