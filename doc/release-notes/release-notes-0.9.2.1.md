Renaiss Core version 0.9.2.1 is now available from:

  https://renaiss.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 REN to 0.01 REN
...
- Fix "Start renaiss on system login"
