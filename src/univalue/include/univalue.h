...
// Copyright 2015 Renaiss Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef RENAISS_UNIVALUE_INCLUDE_UNIVALUE_H
#define RENAISS_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // RENAISS_UNIVALUE_INCLUDE_UNIVALUE_H
