...
#ifndef RENAISS_WALLET_SCRIPTPUBKEYMAN_H
#define RENAISS_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Renaiss Core wallet was originally a collection of unrelated private
...
#endif // RENAISS_WALLET_SCRIPTPUBKEYMAN_H
