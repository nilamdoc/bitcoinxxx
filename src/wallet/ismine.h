...
#ifndef RENAISS_WALLET_ISMINE_H
#define RENAISS_WALLET_ISMINE_H
 ...
 * https://github.com/renaiss/renaiss/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
