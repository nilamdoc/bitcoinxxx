...
#ifndef RENAISS_WALLET_TRANSACTION_H
#define RENAISS_WALLET_TRANSACTION_H
...
public:
     ...
     * on this renaiss node, and set to 0 for transactions that were created
...
#endif // RENAISS_WALLET_TRANSACTION_H
