...
#ifndef RENAISS_WALLET_WALLETUTIL_H
#define RENAISS_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! renaiss from opening the wallet, thinking it was newly created, and
...
#endif // RENAISS_WALLET_WALLETUTIL_H
