...
#ifndef RENAISS_KERNEL_CONTEXT_H
#define RENAISS_KERNEL_CONTEXT_H
...
//! passed to external librenaiss_kernel functions which need access to this
...
#endif // RENAISS_KERNEL_CONTEXT_H
