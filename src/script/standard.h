...
#ifndef RENAISS_SCRIPT_STANDARD_H
#define RENAISS_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a renaiss address
 */
...
/**
 * Generate a Renaiss scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // RENAISS_SCRIPT_STANDARD_H
