...
#ifndef RENAISS_COMPAT_ASSUMPTIONS_H
#define RENAISS_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Renaiss cannot be compiled without assertions."
#endif
...
#endif // RENAISS_COMPAT_ASSUMPTIONS_H
