...
#ifndef RENAISS_RPC_PROTOCOL_H
#define RENAISS_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in renaissd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Renaiss is not connected
