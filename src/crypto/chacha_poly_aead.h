// Copyright (c) 2019-2021 The Renaiss Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RENAISS_CRYPTO_CHACHA_POLY_AEAD_H
#define RENAISS_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@renaiss.
 *
 ...
 *
 * The chacha20-poly1305@renaiss combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@renaiss cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@renaiss are relatively fast in
...
#endif // RENAISS_CRYPTO_CHACHA_POLY_AEAD_H
