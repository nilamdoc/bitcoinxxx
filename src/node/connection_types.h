...
#ifndef RENAISS_NODE_CONNECTION_TYPES_H
#define RENAISS_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/renaiss-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Renaiss’s Peer-to-Peer Network")
...
#endif // RENAISS_NODE_CONNECTION_TYPES_H
