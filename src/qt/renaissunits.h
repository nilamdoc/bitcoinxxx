...
#ifndef RENAISS_QT_RENAISSUNITS_H
#define RENAISS_QT_RENAISSUNITS_H
...
/** Renaiss unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RenaissUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RenaissUnits(QObject *parent);

    /** Renaiss units.
      @note Source: https://en.renaiss.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        REN,
        mREN,
