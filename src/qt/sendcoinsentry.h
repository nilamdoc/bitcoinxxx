...
#ifndef RENAISS_QT_SENDCOINSENTRY_H
#define RENAISS_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending renaisss.
 */
...
#endif // RENAISS_QT_SENDCOINSENTRY_H
