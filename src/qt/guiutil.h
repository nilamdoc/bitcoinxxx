...
#ifndef RENAISS_QT_GUIUTIL_H
#define RENAISS_QT_GUIUTIL_H
...
/** Utility functions used by the Renaiss Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "renaiss:" URI into recipient object, return true on successful parsing
