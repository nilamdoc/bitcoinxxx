...
#ifndef RENAISS_QT_RECEIVECOINSDIALOG_H
#define RENAISS_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of renaisss */
...
#endif // RENAISS_QT_RECEIVECOINSDIALOG_H
