...
#ifndef RENAISS_QT_OPTIONSMODEL_H
#define RENAISS_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Renaiss client.
...
public:
    ...
    RenaissUnit getDisplayUnit() const { return m_display_renaiss_unit; }
...
private:
    ...
    QString language;
    RenaissUnit m_display_renaiss_unit;
    ...
    //! renaiss node but it's also nice to store them in memory to prevent them
...
Q_SIGNALS:
    void displayUnitChanged(RenaissUnit unit);
    void coinControlFeaturesChanged(bool);
    void showTrayIconChanged(bool);
    void useEmbeddedMonospacedFontChanged(bool);
};

#endif // RENAISS_QT_OPTIONSMODEL_H
