    ...
    mapper(nullptr)
{
    ...
    ui->renaissAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->renaissAtStartup);
    ...
    ui->renaissAtStartup->setToolTip(ui->renaissAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->renaissAtStartup->setText(ui->renaissAtStartup->text().arg(PACKAGE_NAME));

    ui->openRenaissConfButton->setToolTip(ui->openRenaissConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new RenaissUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->renaissAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSRENontrols);
...
void OptionsDialog::on_openRenaissConfButton_clicked()
{
