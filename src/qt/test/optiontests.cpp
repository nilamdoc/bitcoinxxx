...
{
    // Test regression https://github.com/renaiss/renaiss/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/renaiss-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/renaiss-core/gui/pull/568.
    // With fListen=false in ~/.config/Renaiss/Renaiss-Qt.conf and all else left as default,
    // renaiss-qt should set both -listen and -listenonion to false and start successfully.
