...
//! Entry point for RenaissApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &RenaissApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for RenaissGUI tests.
void AppTests::guiTests(RenaissGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &RenaissGUI::consoleShown, this, &AppTests::consoleTests);
