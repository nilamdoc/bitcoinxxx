...
#ifndef RENAISS_TEST_SCRIPTNUM10_H
#define RENAISS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Renaiss Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // RENAISS_TEST_SCRIPTNUM10_H
