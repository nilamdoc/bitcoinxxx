...
#ifndef RENAISS_INTERFACES_NODE_H
#define RENAISS_INTERFACES_NODE_H
...
//! Top-level interface for a renaiss node (renaissd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or renaiss.conf.
...
#endif // RENAISS_INTERFACES_NODE_H
