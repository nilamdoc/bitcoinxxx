...
#ifndef RENAISS_INTERFACES_INIT_H
#define RENAISS_INTERFACES_INIT_H
...
//! (renaiss-gui, renaiss-node, renaiss-wallet, renaissd, renaiss-qt) and each
...
#endif // RENAISS_INTERFACES_INIT_H
