 ...
 */
#ifndef RENAISS_UTIL_SYSTEM_H
#define RENAISS_UTIL_SYSTEM_H
...
extern const char * const RENAISS_CONF_FILENAME;
extern const char * const RENAISS_SETTINGS_FILENAME;
