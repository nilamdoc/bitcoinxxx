...
#ifndef RENAISS_UTIL_SYSCALL_SANDBOX_H
#define RENAISS_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during renaissd initialization if Renaiss Core was compiled
...
#endif // RENAISS_UTIL_SYSCALL_SANDBOX_H
