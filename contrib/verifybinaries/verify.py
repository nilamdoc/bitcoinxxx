...
"""Script for verifying Renaiss Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
renaisscore.org and renaiss.org and compares them.
...
WORKINGDIR = "/tmp/renaiss_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://renaisscore.org"
HOST2 = "https://renaiss.org"
VERSIONPREFIX = "renaiss-core-"
...
def main(args):
    ...
    if not success:
        print("renaiss.org failed to provide signature file, "
              "but renaisscore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("renaiss.org and renaisscore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Renaiss Core binary release "
