...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the renaiss repository."
  exit 1
fi
...
# See https://github.com/renaiss/renaiss/issues/16064
...
echo 'When compiling renaissd, run `./configure` in the following way:'
echo
