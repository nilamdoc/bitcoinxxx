...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef RENAISS_CHAINPARAMSSEEDS_H\n')
    g.write('#define RENAISS_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the renaiss network\n')
    ...
    g.write('#endif // RENAISS_CHAINPARAMSSEEDS_H\n')
